...
<div class="modal fade" id="editcompany" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      <form method="POST" action="/admin_edit_company">
        {{ csrf_field() }}
...
<!-- Delete Popup  Start-->
<div class="modal fade" id="deletecompany" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
      ...
      <div class="modal-body">
        <form method="POST" action="/admin_delete_company">
      ...
      <div class="col-lg-8 col-12">
        ...
        <div class="small-box bg-info data-row">
          ...
          <div class="row">
            ...
            <div class="col-2">
              <button  type="button" id="edit-data" class="btn btn-danger" data-toggle="modal" data-target="#editcompany"
              data-id="{{ $company->id}}" data-name="{{ $company->name}}" data-contact_no="{{ $company->contact_no}}" data-email="{{ $company->email}}"
              data-size="{{ $company->size}}" data-address="{{ $company->address}}" data-type="{{ $company->type}}">
                Edit
              </button>
            </div>
            <div class="col-2">
              <button  type="button" id="edit-data" class="btn btn-danger" data-toggle="modal" data-target="#deletecompany"
              data-id="{{ $company->id}}">
                Delete
              </button>
            </div>
